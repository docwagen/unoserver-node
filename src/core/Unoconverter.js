...
class Unoconverter extends BaseService {
    ...
    /**
     * Pass an option for the export filter, in name=value format. Use true/false for boolean values.
     * Can be repeated for multiple options.
     * @param {String} filterOption
     * @returns self
     */
    setFilterOption(filterOption) {
        this._inputArgs.filterOption = filterOption;
        return this;
    }
